...
export class ReportsController {
  ...
  inventoryCurrent(@CurrentUser() user: AuthenticatedPrincipal, @Query() query: ReportQueryDto) {
  ...
  inventoryByCampaign(@CurrentUser() user: AuthenticatedPrincipal, @Query() query: ReportQueryDto) {
  ...
  inventoryByFarmer(@CurrentUser() user: AuthenticatedPrincipal, @Query() query: ReportQueryDto) {
  ...
  purchasesByCampaign(@CurrentUser() user: AuthenticatedPrincipal, @Query() query: ReportQueryDto) {
  ...
  jointPurchases(@CurrentUser() user: AuthenticatedPrincipal, @Query() query: ReportQueryDto) {
  ...
  applicationsByPlotCrop(@CurrentUser() user: AuthenticatedPrincipal, @Query() query: ReportQueryDto) {
  ...
  consumptionByProduct(@CurrentUser() user: AuthenticatedPrincipal, @Query() query: ReportQueryDto) {
  ...
  consumptionByCrop(@CurrentUser() user: AuthenticatedPrincipal, @Query() query: ReportQueryDto) {
  ...
  expiredProducts(@CurrentUser() user: AuthenticatedPrincipal, @Query() query: ReportQueryDto) {
  ...
  payablesAndPayments(@CurrentUser() user: AuthenticatedPrincipal, @Query() query: ReportQueryDto) {
  ...
  auditByCampaign(@CurrentUser() user: AuthenticatedPrincipal, @Query() query: ReportQueryDto) {
    return this.reportsUseCase.auditByCampaign(user.tenantId, this.actor(user), query);
  }

  private actor(user: AuthenticatedPrincipal) {
